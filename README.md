## 🧠 LLM App with Shared Memory
This application demonstrates a LLM system with a shared memory layer, allowing users to interact with different language models while maintaining conversation history and context across sessions.
